...
from nhl_data import fetch_season_games
from analysis_history import get_all_bets_from_history


BET_LOG_PATH = Path(__file__).parent / "bet_results.json"
...
def check_results(days_back: int = 7):
    ...
    for bet in all_bets:
        ...
        if won:
            from odds_fetcher import american_to_decimal
